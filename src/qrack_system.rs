...
pub type intq = ::std::os::raw::c_longlong;
...
extern "C" {
    pub fn init_count(q: uintq, hp: bool, sp: bool) -> uintq;
}
extern "C" {
    pub fn init_count_pager(q: uintq, hp: bool, sp: bool) -> uintq;
}
extern "C" {
    pub fn init_count_stabilizer(q: uintq) -> uintq;
}
extern "C" {
    pub fn init() -> uintq;
}
...
extern "C" {
    pub fn set_device(sid: uintq, did: intq);
}
extern "C" {
    pub fn set_device_list(sid: uintq, n: uintq, dids: *mut intq);
}
extern "C" {
...
extern "C" {
    pub fn HighestProbAll(sid: uintq, r: *mut uintq);
}
extern "C" {
...
extern "C" {
    pub fn VarianceRdm(sid: uintq, n: uintq, q: *mut uintq, r: bool) -> f64;
}
extern "C" {
    pub fn FactorizedVariance(sid: uintq, n: uintq, q: *mut uintq, m: uintq, c: *mut uintq) -> f64;
}
extern "C" {
    pub fn FactorizedVarianceRdm(
        sid: uintq,
        n: uintq,
        q: *mut uintq,
        m: uintq,
...
extern "C" {
    pub fn MatrixExpectationEigenVal(
        sid: uintq,
        n: uintq,
        q: *mut uintq,
        b: *mut f32,
...
extern "C" {
    pub fn PauliExpectation(sid: uintq, n: uintq, q: *mut uintq, b: *mut uintq) -> f64;
}
extern "C" {
    pub fn PauliVariance(sid: uintq, n: uintq, q: *mut uintq, b: *mut uintq) -> f64;
}
extern "C" {
...
extern "C" {
    pub fn PhaseRootN(sid: uintq, p: uintq, n: uintq, q: *mut uintq);
}
extern "C" {
...
extern "C" {
    pub fn MAllLong(sid: uintq, r: *mut uintq);
}
extern "C" {
...
extern "C" {
    pub fn Separate(sid: uintq, n: uintq, q: *mut uintq);
}
extern "C" {
...
extern "C" {
    pub fn qcircuit_out_to_string_length(cid: uintq) -> usize;
}
extern "C" {
    pub fn qcircuit_out_to_string(cid: uintq, f: *mut ::std::os::raw::c_char);
}
